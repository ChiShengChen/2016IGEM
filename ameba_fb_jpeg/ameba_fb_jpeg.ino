...
char ssid[] = "IEILab";     // your network SSID (name)
char pass[] = "ieilab00";  // your network password
int keyIndex = 0;                // your network key Index number (needed only for WEP)

char server[] = "graph.facebook.com";    // facebook graph api service

char access_token[] = "EAAb03LeiyNkBAC6UQOloVUblhlnMZB1fVdoxKUWr5ckj1xZBbzqFM5xKmA74UvFKxbX3EdvWYqZBNuV1CBq0uYblZCMA3m5rZARZBF7dH9IG8Om2r2pLD6WBUoN8wsvHBh9xwPORhttKUpJS2LsM59xQIzO56ZAaRfwVOdqC1LllD8mhaLhRlTHUmKzU16iv2avxfusqZCPPCcS3z0sgQMPrUCs869sz4NuuTVgEirmymgZDZD";
