...
public class MainActivity extends AppCompatActivity {
    ...
    private Button bt_rightturn;
    private Button bt_leftturn;
    private Button bt_sprint;
    private Button bt_antisprint;
    ...
    private void createWidget() {
        ...
        bt_forward.setOnTouchListener(new RepeatListener(100, 100, new View.OnClickListener() {
            @Override
        ...
        bt_backward.setOnTouchListener(new RepeatListener(100, 100, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new sendMessage("backward").start();
            }
        }));
        bt_rightturn = (Button) findViewById(R.id.rightturn);
        bt_rightturn.setOnTouchListener(new RepeatListener(100, 100, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new sendMessage("rightturn").start();
            }
        }));
        bt_leftturn = (Button) findViewById(R.id.leftturn);
        bt_leftturn.setOnTouchListener(new RepeatListener(100, 100, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new sendMessage("leftturn").start();
            }
        }));
        bt_sprint = (Button) findViewById(R.id.sprint);
        bt_sprint.setOnTouchListener(new RepeatListener(100, 100, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new sendMessage("sprint").start();
            }
        }));
        bt_antisprint = (Button) findViewById(R.id.antisprint);
        bt_antisprint.setOnTouchListener(new RepeatListener(100, 100, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new sendMessage("antisprint").start();
            }
        }));
    }
